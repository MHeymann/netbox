...
ADDRESS_OBJS	   = $(OBJ_DIR)/server/address_alloc.o
...
SERVER_OBJS = $(HSET_OBJS) $(PACKET_OBJS) $(QUEUE_OBJS) $(USERS_OBJS) $(SERVER_SOCKET_OBJS) $(ADDRESS_OBJS)
CLIENT_OBJS = $(PACKET_OBJS) $(QUEUE_OBJS) $(CLIENT_SOCKET_OBJS) 


OBJS = $(SERVER_OBJS) $(CLIENT_OBJS)
TESTEXES = test_address_alloc
...
test_address_alloc: $(ADDRESS_OBJS) $(SRC_DIR)/server/test_address_alloc.c
	$(COMPILE) -o $@ $^ $(LFLAGS)
